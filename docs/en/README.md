...
| --- | --- | --- | --- | --- |
| 01 | [Overall architecture](01-gesamtarchitektur.md) *(in progress)* | Beginners, makers | Understand parts, six scripts, schedule and KVS in five minutes | – |
| 02 | [Flow: cycle, job, window, check, pause](02-flussdiagramm.md) *(in progress)* | Operators, makers | Know what the device does in a day and why it is not watering right now | – |
...
| 04 | [Safety and limits](04-sicherheit-und-grenzen.md) *(in progress)* | Everyone before building | Why the pump never runs away and where the Shelly and the SMT50 hit their limits | – |
...
| No. | Chapter | For whom | Outcome | Diagram |
| --- | --- | --- | --- | --- |
| 06 | [Step-by-step start guide](06-startanleitung.md) *(in progress)* | Everyone | From the wired device to the first watering window, choosing an installation route | – |
...
| No. | Chapter | For whom | Outcome | Diagram |
| --- | --- | --- | --- | --- |
| 14 | [Debugging and testing](14-debuggen-und-testen.md) *(in progress)* | Developers, agents | Mock, tests, build, upload and console; complete tool reference | – |
| 15 | [Extending the controller with Claude Code](15-ausbau-mit-claude-code.md) *(in progress)* | Anyone extending it | Plan, interview, acceptance criteria, debug environment, coding, verification, commit | – |
