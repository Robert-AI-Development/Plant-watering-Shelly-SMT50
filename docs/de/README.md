...
| 02 | [Flussdiagramm: Takt, Auftrag, Fenster, Kontrolle, Pause](02-flussdiagramm.md) *(im Aufbau)* | Betreiber, Maker | Wissen, was das Gerät an einem Tag tut und warum es gerade nicht gießt | – |
...
| 04 | [Sicherheit und Grenzen](04-sicherheit-und-grenzen.md) *(im Aufbau)* | Alle vor dem Aufbau | Warum die Pumpe nie durchläuft und wo Shelly und SMT50 an Grenzen stoßen | – |
