...
| 03 | [Konfigurations-Zusammenspiel (Parameter-Referenz)](03-konfiguration.md) | Alle, die ein Feld ändern | Jedes Feld: wer liest es, was bewirkt es, wann muss der Installer neu laufen | [interaktiv](https://robert-ai-development.github.io/Plant-watering-Shelly-SMT50/diagramme/de/03-konfiguration.html) |
...
| Nr | Kapitel | Für wen | Ergebnis | Diagramm |
| --- | --- | --- | --- | --- |
| 06 | [Schritt-für-Schritt-Startanleitung](06-startanleitung.md) | Alle | Vom verdrahteten Gerät zum ersten Gießfenster, Wegwahl zu den Installationsarten | [interaktiv](https://robert-ai-development.github.io/Plant-watering-Shelly-SMT50/diagramme/de/06-startanleitung.html) |
| 07 | [Installation per Hand (Web-UI, Copy & Paste)](07-installation-per-hand.md) | Ohne Node, ohne Terminal | Scripts aus dist/ eingefügt, Byte-Prüfung bestanden, Installer gelaufen | [interaktiv](https://robert-ai-development.github.io/Plant-watering-Shelly-SMT50/diagramme/de/07-installation-per-hand.html) |
| 08 | [Installation mit lokalem Server (PC oder Raspberry im LAN)](08-installation-lokaler-server.md) | Node ≥ 22 im selben Netz | Upload, Prüfung und Installer mit den Werkzeugen direkt gegen die IP | [interaktiv](https://robert-ai-development.github.io/Plant-watering-Shelly-SMT50/diagramme/de/08-installation-lokaler-server.html) |
| 09 | [Installation mit VPS-Server (SSH-Rückwärtstunnel)](09-installation-vps.md) | Arbeit auf einem Server | Shelly zuhause über 127.0.0.1:8010 erreichbar, Werkzeuge und Claude Code auf dem VPS | [interaktiv](https://robert-ai-development.github.io/Plant-watering-Shelly-SMT50/diagramme/de/09-installation-vps.html) |
| 10 | [Installation mittels Claude Code](10-installation-claude-code.md) | KI soll führen | Installation im Interview: was Claude tut, was der Mensch entscheidet | [interaktiv](https://robert-ai-development.github.io/Plant-watering-Shelly-SMT50/diagramme/de/10-installation-claude-code.html) |
...
| 13 | [Betrieb und Wartung](13-betrieb-und-wartung.md) | Betreiber im Alltag | Ablesen, Codes deuten, Störung beheben, aktualisieren, warten, verreisen | [interaktiv](https://robert-ai-development.github.io/Plant-watering-Shelly-SMT50/diagramme/de/13-betrieb-und-wartung.html) |
...
| 15 | [Ausbau der Steuerung mit Claude Code](15-ausbau-mit-claude-code.md) | Wer erweitern will | Plan, Interview, Prüfkriterien, Debug-Umgebung, Coding, Prüfung, Commit | [interaktiv](https://robert-ai-development.github.io/Plant-watering-Shelly-SMT50/diagramme/de/15-ausbau-mit-claude-code.html) |
...
| 18 | [Lernlog vom Gerät](18-lernlog-geraet.md) | Wer eine Überraschung einordnet | Jeder Gerätefund mit Symptom, Ursache, Fix und Regel im Test | [interaktiv](https://robert-ai-development.github.io/Plant-watering-Shelly-SMT50/diagramme/de/18-lernlog-geraet.html) |
| 19 | [Prüfprotokoll am Gerät](19-pruefprotokoll.md) | Wer Messwerte braucht | Was am echten Aufbau gemessen wurde; Vorlage für den nächsten Lauf | [interaktiv](https://robert-ai-development.github.io/Plant-watering-Shelly-SMT50/diagramme/de/19-pruefprotokoll.html) |
| 20 | [RPC- und Engine-Referenz](20-rpc-referenz.md) | Wer einen RPC einbaut | Jede genutzte RPC mit Parametern, Antwort und Doku-Link; Engine-Fakten mit Messdatum | [interaktiv](https://robert-ai-development.github.io/Plant-watering-Shelly-SMT50/diagramme/de/20-rpc-referenz.html) |
| 21 | [SEO und Keywords](21-seo-keywords.md) | Wer das Projekt auffindbar macht | Keyword-Cluster, Platzierung, GitHub-Topics | [interaktiv](https://robert-ai-development.github.io/Plant-watering-Shelly-SMT50/diagramme/de/21-seo-keywords.html) |
